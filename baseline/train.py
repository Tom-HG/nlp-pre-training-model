...
if __name__ == '__main__':
    ...
    pretrained_model = './bert_pretrain_model/bert-base-chinese'
    tokenizer_model = './bert_pretrain_model/bert-base-chinese'
    train(batchSize=4, device='cuda:0', lr=0.0001, use_dtp=True, pretrained_model=pretrained_model, tokenizer_model=tokenizer_model, weighted_loss=True)